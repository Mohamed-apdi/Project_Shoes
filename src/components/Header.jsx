      ...
      <div className="container py-4">
        <div className="flex justify-around items-center">
          ...
          <div className="search relative items-center w-1/4">
            <input
              className="border p-2 rounded-md w-full bg-gray-200 pl-6 text-sm outline-none"
              type="text"
          ...
          <div className="flex justify-between gap-5">
            <div className="flex flex-col items-center">
              <div className="cart relative">
                ...
                <span className="items-center absolute top-[-14px] right-[-8px] rounded-full border px-[7px] bg-yellow-300 py-[1.5px] text-xs font-semibold transition-colors">
                  4
                </span>
              </div>
